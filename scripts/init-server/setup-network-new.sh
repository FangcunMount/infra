...
start_mihomo_service() {
    ...
    # 通过 systemd 启动服务
    log_info "启动 mihomo 服务（HTTP 7890 / SOCKS5 7891 / Mixed 7893）..."
...
# 便捷的代理开关别名
alias proxy-on='export http_proxy=http://127.0.0.1:7890; export https_proxy=http://127.0.0.1:7890; export all_proxy="socks5://127.0.0.1:7891"; echo "🟢 Proxy is ON"'
...
show_completion_info() {
    ...
    echo
    log_info "服务信息："
    echo "  🌐 端口：HTTP 7890 / SOCKS5 7891 / Mixed 7893"
